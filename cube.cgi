...
<body>
<img src="./Goods_Photo/cube.png" width="300"height="230"/>
<a href='./cube_cart.cgi'><img src='./button/add.png' width='50'height='50' alt='カートに追加'/></a>
<nobr><a href='./cube_cart.cgi'>カートに追加</a></nobr>
<br>商品名:cube</br>
<br>値段:300</br>
<br>状態:目立った傷なし</br>
<br>地域:北海道</br>
<br>配達方法:お手軽郵送</br>
<br>商品説明:頭の体操になります</br>
</body>
</html>
    '''
print(htmlText.encode("utf-8", 'ignore').decode('utf-8'))
