...
<body>
<img src="./Goods_Photo/controller.png" width="300"height="230"/>
<a href='./controller_cart.cgi'><img src='./button/add.png' width='50'height='50' alt='カートに追加'/></a>
<nobr><a href='./controller_cart.cgi'>カートに追加</a></nobr>
<br>商品名:controller</br>
<br>値段:5000</br>
<br>状態:新品・未使用</br>
<br>地域:北海道</br>
<br>配達方法:お手軽郵送</br>
<br>商品説明:何に使えるんでしょうか</br>
</body>
</html>
    '''
print(htmlText.encode("utf-8", 'ignore').decode('utf-8'))
