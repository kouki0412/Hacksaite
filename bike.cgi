...
<body>
<img src="./Goods_Photo/bike.png" width="300"height="230"/>
<a href='./bike_cart.cgi'><img src='./button/add.png' width='50'height='50' alt='カートに追加'/></a>
<nobr><a href='./bike_cart.cgi'>カートに追加</a></nobr>
<br>商品名:bike</br>
<br>値段:400000</br>
<br>状態:目立った傷なし</br>
<br>地域:茨城県</br>
<br>配達方法:通常郵送</br>
<br>商品説明:乗り心地がいいです</br>
</body>
</html>
    '''
print(htmlText.encode("utf-8", 'ignore').decode('utf-8'))
